...
export const fetchUsers = createAsyncThunk<UserWithRolesAndPermission[], void, { rejectValue: string }> (
    "users/getAll",
    async (_, thunkAPI) => {
        try {
...
export const fetchUserById = createAsyncThunk<UserWithRolesAndPermission | undefined, string, { rejectValue: string }>(
    "users/fetchById",
    async (id, thunkAPI) => {
        try {
...
export const fetchMe = createAsyncThunk<UserWithRolesAndPermission | undefined, string, { rejectValue: string }>(
    "users/fetchMe",
    async (_, thunkAPI) => {
        try {
